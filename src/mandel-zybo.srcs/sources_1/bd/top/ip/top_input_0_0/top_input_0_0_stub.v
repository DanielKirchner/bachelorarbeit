...
module top_input_0_0(rdy_in, clk, reset, btns, x1, y1, x2, y2, max_iter, 
  rdy_out)
/* synthesis syn_black_box black_box_pad_pin="rdy_in,clk,reset,btns[7:0],x1[39:0],y1[39:0],x2[39:0],y2[39:0],max_iter[13:0],rdy_out" */;
  input rdy_in;
  input clk;
  input reset;
  input [7:0]btns;
