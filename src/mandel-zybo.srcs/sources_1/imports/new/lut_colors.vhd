...
begin
r<=
    "11111" when index = "0000" and mode = "00" else   --MODE 00 : White to Black
    ...
    "00000" when index = "1111" and mode = "00" else                     
    
    "11111" when index = "0000" and mode = "01" else   --MODE 01: Green to Red
    ...
    "00000" when index = "1111" and mode = "01" else
    ...
    "00000" when index = "1111" and mode = "10" else
    ...
    "00000" when index = "1111" and mode = "11" else
    "00000";

-- ATTENTION: G HAS ONE MORE BIT THAN R AND B
g <=    
    "111111" when index = "0000" and mode = "00" else   --MODE 00 : White to Black      
    ...
    "000000" when index = "1111" and mode = "00" else
    
    "111111" when index = "1111" and mode = "01" else   --MODE 01: Green to Red
    "111011" when index = "1110" and mode = "01" else                         
    "110111" when index = "1101" and mode = "01" else                         
    "110010" when index = "1100" and mode = "01" else                         
    "101110" when index = "1011" and mode = "01" else                         
    "101010" when index = "1010" and mode = "01" else                         
    "100110" when index = "1001" and mode = "01" else                         
    "100010" when index = "1000" and mode = "01" else                         
    "011101" when index = "0111" and mode = "01" else                         
    "011001" when index = "0110" and mode = "01" else                         
    "010101" when index = "0101" and mode = "01" else                         
    "010001" when index = "0100" and mode = "01" else                         
    "001101" when index = "0011" and mode = "01" else                         
    "001000" when index = "0010" and mode = "01" else                         
    "000100" when index = "0001" and mode = "01" else
    "000000" when index = "0000" and mode = "01" else
    ...
    "000000" when index = "1111" and mode = "10" else
    ...
    "000000" when index = "1111" and mode = "11" else
    "000000";
...
b<=
    ...
    "00000" when mode = "01" else                                    --MODE 01: Green to Red             
