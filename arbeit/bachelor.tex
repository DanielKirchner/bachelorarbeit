...
Der obere linke Pixel repräsentiert hierbei den Punkt (\textbf{x1}/\textbf{y1}), während der Pixel rechts von ihm dem Punkt ((\textbf{x1 + step\_y})/\textbf{y1}) darstellt.
