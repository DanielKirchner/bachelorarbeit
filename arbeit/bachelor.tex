...
Fraktale besitzen oft selbstähnliche Strukturen, d.h. dass sich die Gesamtstruktur eines Objektes in kleinerem Maßstab immer wieder findet. Ein Beispiel hierfür ist ein fraktal definierter Baum wie er in \autoref{fig:tree} abgebildet ist. Der Baum wird hierbei über ein einfaches rekursives Verfahren aufgebaut, bei dem immer wieder von jedem Teilbaum aus mit einem festen Winkel abgebogen wird.
