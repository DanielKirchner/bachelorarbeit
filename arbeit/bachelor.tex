...
\begin{figure}[H]
	...
	\caption{Blumenkohlsh, von Rainer Renz}
...
Die hier erwähnte Hausdorff-Besicovitch Dimension ist ein Maß, welches einem beliebigen geometrischen Raum zugeordnet werden kann, wobei die Dimension hier keine natürliche Zahl sein muss. Stark vereinfacht ermittelt sich die Hausdorff-Dimension folgendermaßen:\\
...
Bei den hier gezeigten Formen entspricht die Hausdorff-Dimension stets der herkömmlichen Definition der Dimension. Fraktale, wie etwa die Sierpinski Fläche, besitzen jedoch ei
