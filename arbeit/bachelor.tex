...
\begin{abstract}
Im Rahmen dieser Bachelorarbeit wird eine hardwarebasierte Visualisierung der Mandelbrotmenge auf einem FPGA realisiert.\\
Hierfür werden diverse mathematische und designtechnische Performanceoptimierungen vorgestellt, welche in einem parallelen FPGA-Design implementiert werden.
Das Projekt wird für das Zybo Zynq-7000 Trainer Board entwickelt, welches über einen VGA-Output die Repräsentation des Mandelbrotfraktals in Form eines 800x600@60Hz Videosignals ausgibt.\\
Zur optimalen Ausnutzung der auf diesem Board gegebenen Ressourcen (DSPs, BRAM) wird die \textit{Vivado Design Suite} mit dem integrierten IP-Katalog verwendet.\\
Die entwickelte Hardware kann mit Tastern, welche über eine PMOD-Schnittstelle angeschlossen sind, gesteuert werden.\\\\\\
...
\hyphenation{selbst-er-stell-ten}
...
\begin{table}[H]
	...
	\label{tab:farben01}
\end{table}
Zwischen den verschiedenen Farbtabellen kann im laufenden Betrieb jederzeit umgeschaltet werden, hierfür erhält \textbf{LUT1} noch den Input zweier, auf dem Board integrierter, Schalter.
Insgesamt sind also vier verschiedene Farbtabellen auswählbar, welche in \autoref{chap:farbtabellen} dargestellt sind.
...
Die Farbtabellen der Modi 3 und 4 sind die beiden hier gezeigten Tabellen in umgekehrter Farbreihenfolge (also z.B. \textcolor{red}{rot} $\rightarrow$ \textcolor{green}{grün} wird zu \textcolor{green}{grün} $\rightarrow$ \textcolor{red}{rot}).

\chapter{Ausschnitte der Mandelbrotmenge}
\label{chap:mandelpics}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{mb1.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{mb2.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{mb3.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{mb4.png}
\end{figure}
